...
const projection = `(to_jsonb(r)-'search_document') || jsonb_build_object('workflow',CASE WHEN r.provider='github' AND r.workflow='Local CI' THEN 'GitHub Actions' ELSE r.workflow END,'incident',to_jsonb(i))`
