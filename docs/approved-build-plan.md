...
Status: approved by the user on September 7, 2026. Milestones a, b and c are implemented and validated; confirmation is required before d. Wording describing proposals below records the approved design; current implementation status is maintained in milestones.md.
